                            ...
                            <div class='col-sm-6 col-md-7 product-info-block'>
                                <div class="product-info">
                                    ...
                                    <div class="description-container m-t-20">
                                        @if(session()->get('language') == 'france') {{ $product->short_descp_fr }} @else {{ $product->short_descp_en }} @endif
                                ...
                                <div class="tab-content">
                                    ...
                                    <div id="description" class="tab-pane in active">
                                        <div class="product-tab">
                                            <p class="text">@if(session()->get('language') == 'france')
                                                    {!! $product->long_descp_fr !!} @else {!! $product->long_descp_en !!} @endif</p>
                                        </div>
                                    </div><!-- /.tab-pane -->
