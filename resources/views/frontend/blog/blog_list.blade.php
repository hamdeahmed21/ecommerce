                    ...
                    <div class="col-md-9">
                        ...
                        @foreach($blogpost as $blog)
                            <div class="blog-post  wow fadeInUp">
                                ...
                                <h1><a href="blog-details.html"> @if(session()->get('language') == 'france') {{ $blog->post_title_fr }} @else {{ $blog->post_title_en }} @endif</a></h1>

                                <span class="date-time"> {{ Carbon\Carbon::parse($blog->created_at)->diffForHumans()  }}</span>

                                <p>@if(session()->get('language') == 'france') {!! Str::limit($blog->post_details_fr, 200 )  !!} @else {!! Str::limit($blog->post_details_en, 200 )  !!} @endif</p>
