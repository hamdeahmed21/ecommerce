                ...
                <div class="blog-page">
                    <div class="col-md-9">
                        <div class="blog-post wow fadeInUp">
                            ...
                            <h1>@if(session()->get('language') == 'france') {{ $blogpost->post_title_fr }} @else {{ $blogpost->post_title_en }} @endif</h1>
                            ...
                            <p> @if(session()->get('language') == 'france') {!!  $blogpost->post_details_fr  !!} @else {!!  $blogpost->post_details_en  !!} @endif
                            </p>
