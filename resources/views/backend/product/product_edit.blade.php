                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="row"> <!-- start 2nd row  -->
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <h5>Product Name France <span class="text-danger">*</span></h5>
                                                    <div class="controls">
                                                        <input type="text" name="product_name_fr" class="form-control" required=""  value="{{ $products->product_name_fr }}">
                                        ...
                                        <div class="row"> <!-- start 4th row  -->
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <h5>Product Tags France <span class="text-danger">*</span></h5>
                                                    <div class="controls">
                                                        <input type="text" name="product_tags_fr" class="form-control" value="{{ $products->product_tags_fr }}" data-role="tagsinput" required="">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <h5>Product Size France <span class="text-danger">*</span></h5>
                                                    <div class="controls">
                                        ...
                                        <div class="row"> <!-- start 5th row  -->
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <h5>Product Color France <span class="text-danger">*</span></h5>
                                                    <div class="controls">
                                                        <input type="text" name="product_color_fr" class="form-control" value="{{ $products->product_color_fr }}" data-role="tagsinput" required="">
	...
	<textarea name="short_descp_en" id="textarea" class="form-control" required placeholder="Textarea text">
		{!! $products->short_descp_en !!}
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <h5>Short Description France <span class="text-danger">*</span></h5>
                                                    <div class="controls">
	...
	<textarea id="editor1" name="long_descp_en" rows="10" cols="80" required="">
		{!! $products->long_descp_en !!}
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <h5>Long Description France <span class="text-danger">*</span></h5>
                                                    <div class="controls">
