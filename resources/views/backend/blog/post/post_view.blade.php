                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="row"> <!-- start 2nd row  -->
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <h5>Post Title France <span class="text-danger">*</span></h5>
                                                    <div class="controls">
	...
	<textarea id="editor1" name="post_details_en" rows="10" cols="80" required="">
		Post Details English
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <h5>Post Details France <span class="text-danger">*</span></h5>
                                                    <div class="controls">
	<textarea id="editor2" name="post_details_fr" rows="10" cols="80">
		Post Details France
						</textarea>
                                                    </div>
                                                </div>
